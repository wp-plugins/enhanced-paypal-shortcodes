...
a2 = The value to charge 

p2 = The duration between charging 
...
switch($atts['type']):
	...
	$code = '
        ...
        $code.='"><form name="EFTcart" action="https://www.paypal.com/cgi-bin/webscr" method="post">
